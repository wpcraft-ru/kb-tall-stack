...
* [Custom schema filters](./filters/custom#custom-filter-schemas) (e.g., creation\_date) use the actual form field names. If the field is named `date`, access it like this: `$filters['creation_date']['date']`
...
<EditOnGitHub version="5.x" path="packages/tables/docs/09-custom-data.md" />
