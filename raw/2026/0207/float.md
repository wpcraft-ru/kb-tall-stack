...
<article> <img class="float-start ..." src="/img/mountains.jpg" /> <p>Maybe we can live without libraries, people like you and me. ...p>article><article dir="rtl"> <img class="float-start ..." src="/img/mountains.jpg" /> <p>... ربما يمكننا العيش بدون مكتبات، أشخاص مثلي ومثلك. ربما. بالتأكيدp>article>
Disabling a float
...
On this page
• ExamplesFloating elements to the rightFloating elements to the leftUsing logical propertiesDisabling a floatResponsive design
• Floating elements to the right
• Floating elements to the left
• Using logical properties
Tailwind CSS
