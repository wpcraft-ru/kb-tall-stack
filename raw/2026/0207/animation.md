...
<button type="button" class="bg-indigo-600 ..." disabled> <svg class="mr-3 size-5 motion-safe:animate-spin ..." viewBox="0 0 24 24"> svg> Processingbutton>
Using a custom value
Use the animate-[] syntax to set the animation based on a completely custom value:
<div class="animate-[wiggle_1s_ease-in-out_infinite] ..."> div>
For CSS variables, you can also use the animate-() syntax:
<div class="animate-(--my-animation) ..."> div>
This is just a shorthand for animate-[var()] that adds the var() function for you automatically.
Responsive design
