...
<div> <button x-on:click="$wire.showModal = true">New Postbutton> <div wire:show="showModal"> <form wire:submit="save"> <textarea wire:model="content">textarea> <button type="submit">Save Postbutton> form> div>div>
<button x-on:click="$wire.showModal = true">New Postbutton>
...
<div> <button x-on:click="$wire.showModal = true">New Postbutton> <div wire:show="showModal" x-transition.duration.500ms> <form wire:submit="save"> <textarea wire:model="content">textarea> <button type="submit">Save Postbutton> form> div>div>
<button x-on:click="$wire.showModal = true">New Postbutton>
