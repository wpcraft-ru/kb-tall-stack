...
<div x-data="{ count: 0 }"> <h2 x-text="count">h2> <button x-on:click="count++">+button>div>
...
<form wire:submit="save"> <input wire:model="title" type="text"> <button type="button" x-on:click="$wire.title = ''">Clearbutton> <button type="submit">Savebutton>form>
<input wire:model="title" type="text">
<button type="button" x-on:click="$wire.title = ''">Clearbutton>
<button type="submit">Savebutton>
...
<form wire:submit="save"> <input wire:model="title" type="text" x-on:blur="$wire.save()"> <button type="submit">Savebutton>form>
...
<div x-data="{ open: $wire.entangle('showDropdown') }"> <button x-on:click="open = true">Show More...button> <ul x-show="open"> <li><button wire:click="archive">Archivebutton>li> ul>div>
<div x-data="{ open: $wire.entangle('showDropdown') }">
<button x-on:click="open = true">Show More...button>
<li><button wire:click="archive">Archivebutton>li>
...
• Properties — Access Livewire properties from Alpine using $wire
• Actions — Call Livewire actions from Alpine
• JavaScript — Execute custom JavaScript in components
• Events — Dispatch and listen for events with Alpine
